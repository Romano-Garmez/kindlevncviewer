...
## Changes
- Touching in top left of the screen quits the VNC viewer. Previously, there was no way to quit the viewer other than ssh-ing into the Kindle, or force rebooting the Kindle.
